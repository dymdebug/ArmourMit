...
using RMTFRK.Core.Helper.Net.QMail.Config;
using RMTFRK.Core.Helper.Net.QMail.EventHandler;

namespace RMTFRK.Core.Helper.Net.QMail
{
    /// <summary> 
    ...
    internal class MailManager
    {
        ...
        private MailManager()
        {
            ...
            {
                System.Type tp = System.Type.GetType(_mailSection.EventReceiver);
