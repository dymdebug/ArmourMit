...
using RMTFRK.Core.Helper.Log;
using RMTFRK.Core.Helper.Security;
using RMTFRK.Core.Interface;

namespace RMTFRK.Core.Helper.DB
{
	public class NSqlServerHelper : IDbHelper, IDisposable
	{
		...
		public NSqlServerHelper(string connString)
		{
		...
		public SqlDatabase GetDatabase()
		{
			...
			if (this.db == null)
			{
				...
				{
					this.db = new SqlDatabase(NdesEncrypt.Decrypt(this.connectionString));
				}
				else
				{
