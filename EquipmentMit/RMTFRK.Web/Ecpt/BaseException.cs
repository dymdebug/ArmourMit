...
namespace RMTFRK.Web.Ecpt
{
    public class BaseException
    {
        ...
        private bool isShow;
        private System.Exception outermostException;
        ...
        public System.Exception Exception
        {
            get
            {
                return (HttpContext.Current.Session["Exception"] as System.Exception);
            }
            private set
            {
        ...
        public BaseException()
        {
            ...
            try
            {
                this.Exception = HttpContext.Current.Application["LastError"] as System.Exception;
        ...
        private string GetExceptionName(System.Exception ex)
        {
            string str = null;
            if (ex != null)
            {
        ...
        private string GetStackInfo(System.Exception ex)
        {
            string str = null;
            if (ex != null)
            {
        ...
        private string GetTargetSite(System.Exception ex)
        {
            string str = null;
            if (ex != null)
            {
        ...
        protected System.Exception GetBenmostException(System.Exception ex)
        {
            while (true)
            {
                if (ex.InnerException != null)
