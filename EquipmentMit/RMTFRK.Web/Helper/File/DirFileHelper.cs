...
namespace RMTFRK.Web.Helper.File
{
	public static class DirFileHelper
	{
		...
		{
			if (System.IO.File.Exists(HttpContext.Current.Request.PhysicalApplicationPath + file))
			{
				System.IO.File.Delete(HttpContext.Current.Request.PhysicalApplicationPath + file);
			}
		}
		...
		public static void MoveFile(string dir1, string dir2)
		{
			dir1 = dir1.Replace("/", "\\");
			dir2 = dir2.Replace("/", "\\");
			if (System.IO.File.Exists(HttpContext.Current.Request.PhysicalApplicationPath + "\\" + dir1))
			{
				System.IO.File.Move(HttpContext.Current.Request.PhysicalApplicationPath + "\\" + dir1, HttpContext.Current.Request.PhysicalApplicationPath + "\\" + dir2);
			}
		}
		...
		public static void CopyFile(string dir1, string dir2)
		{
			...
			if (System.IO.File.Exists(HttpContext.Current.Request.PhysicalApplicationPath + "\\" + dir1))
			{
				System.IO.File.Copy(HttpContext.Current.Request.PhysicalApplicationPath + "\\" + dir1, HttpContext.Current.Request.PhysicalApplicationPath + "\\" + dir2, true);
			}
		}
