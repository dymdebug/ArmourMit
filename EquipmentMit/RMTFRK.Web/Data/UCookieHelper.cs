...
namespace RMTFRK.Web.Data
{
    ...
    public class UCookieHelper
    {
        ...
        public static void SaveCookie(string CookieName, string CookieValue, double CookieTime)
        {
            ...
            myCookie.Value = NdEncrypt.Encrypt(HttpUtility.HtmlEncode(CookieValue), "chinacloudtech");
            if (CookieTime != 0)
            {
        ...
        public static string GetCookie(string CookieName)
        {
            ...
            if (myCookie != null)
            {
                string cookievalue = NdEncrypt.Decrypt(myCookie.Value, "chinacloudtech");
